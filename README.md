...
입장 로또는 사용자의 생년월일시를 바탕으로 동양 철학의 사주 명리학 원리를 적용하여 행운의 번호를 추출해 주는 서비스입니다.

---

## 🔮 사주 기반 숫자 추출 알고리즘

입장 로또는 단순히 무작위 숫자를 생성하지 않습니다. 전통적인 사주 명리학의 **'오행(五行)' 수리**와 개인의 **사주 정보**를 결합한 독자적인 알고리즘을 사용합니다.
...
*   **⛰️ 안정(土):** 5, 10 계열 (기반을 튼튼히 하고 중심을 잡는 기운)
